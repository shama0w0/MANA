	...
	if($_POST['nombre_car']!=NULL && $_POST['descripcion_car']!=NULL)
		{
					...
					$buffer = $_SESSION["id"]."TXIN 000580046inscar00".$nombrec.$j;
					$salida = ' ';
...
?> 
	...
	<form name = 'usuarios'  method = 'POST' action='inscar.php' onSubmit = 'return validar(this);'>
			<center><tr><td>Nombre cargo: </td><td><input type='text' name='nombre_car' MAXLENGTH=60 /></td></tr><br />
